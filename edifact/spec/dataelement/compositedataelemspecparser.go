...
type CompositeDataElemSpecParser struct {
	simpleDataElemSpecs SimpleDataElemSpecMap
...
func (p *CompositeDataElemSpecParser) ParseHeader(header string) (id string, name string, err error) {
...
func (p *CompositeDataElemSpecParser) ParseSpec(specLines []string) (spec *CompositeDataElemSpec, err error) {
	...
	spec = NewCompositeDataElemSpec(id, name, descr, componentSpecs)

	return
}

// Parse composite data element spec file, e.g. EDCD14.B
func (p *CompositeDataElemSpecParser) ParseSpecFile(fileName string) (specs CompositeDataElemSpecMap, err error) {
